...
* **Dynamic Port Scanning:** Reads target IPs and unique ports (e.g., 443, 7443, 8443, 5061) directly from a CSV.
...
| 10.201.115.113 | 5061 |
| 10.201.115.115 | 8443 |
* Note: If a port isnt provided, 443 is default value. If 8443/5061 is provided TCP Stream handshake is used for SIP/MRA/Expressway/UCM.
---
